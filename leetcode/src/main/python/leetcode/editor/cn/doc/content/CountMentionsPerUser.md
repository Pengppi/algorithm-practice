...
<ol> 
 <li><strong>Message Event:</strong> <code>["MESSAGE", "timestamp<sub>i</sub>", "mentions_string<sub>i</sub>"]</code> </li>
</ol>
...
<div><div>Related Topics</div><div><li>数组</li><li>数学</li><li>排序</li><li>模拟</li></div></div><br><div><li>👍 20</li><li>👎 0</li></div>