...
<ul> 
 <li>Choose <code>curr = 3</code>, and a movement direction to the left. </li>
</ul>
...
<div><div>Related Topics</div><div><li>数组</li><li>前缀和</li><li>模拟</li></div></div><br><div><li>👍 24</li><li>👎 0</li></div>